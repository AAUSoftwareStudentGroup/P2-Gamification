...
namespace ThreeOneSevenBee.Development.Desktop
{
	...
	public class MouseDevice
	{
		...
		public event Action<MouseButtons, MouseState> ButtonPressed;
		public event Action<MouseButtons, MouseState> ButtonReleased;
		public event Action<MouseButtons, MouseState> ButtonHeld;

		// Constructor gets the initial MouseState, moves the mouse to the
		// center of the screen, and does the first update
		public MouseDevice(GraphicsDevice graphics)
		{
