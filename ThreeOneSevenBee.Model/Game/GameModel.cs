    ...
    public class GameModel
    {
        ...
        public void SetLevel(int level, int category)
        {
            ...
            ExprModel = new ExpressionModel(User.Categories[category][level].CurrentExpression, (m) => onExpressionChanged(m),
                ...
                Rules.RemoveParenthesisRule, Rules.ProductOfConstantAndFraction, Rules.FactorizeUnaryMinus, Rules.FactorizationRule, Rules.RemoveNull, Rules.MultiplyByNull);
