(function (globals) {
    ...
    Bridge.define('ThreeOneSevenBee.Framework.Euclidean.Circle', {
        ...
        config: {
            init: function () {
                this.center = new ThreeOneSevenBee.Framework.Euclidean.Vector2() || new ThreeOneSevenBee.Framework.Euclidean.Vector2();
            }
        },
        ...
        contains: function (rectangle) {
            return this.contains$1(new ThreeOneSevenBee.Framework.Euclidean.Vector2("constructor$1", rectangle.getLeft(), rectangle.getTop())) && this.contains$1(new ThreeOneSevenBee.Framework.Euclidean.Vector2("constructor$1", rectangle.getRight(), rectangle.getTop())) && this.contains$1(new ThreeOneSevenBee.Framework.Euclidean.Vector2("constructor$1", rectangle.getRight(), rectangle.getBottom())) && this.contains$1(new ThreeOneSevenBee.Framework.Euclidean.Vector2("constructor$1", rectangle.getLeft(), rectangle.getBottom()));
        },
    ...
    Bridge.define('ThreeOneSevenBee.Framework.Euclidean.Rectangle', {
        ...
        config: {
            init: function () {
                this.location = new ThreeOneSevenBee.Framework.Euclidean.Vector2() || new ThreeOneSevenBee.Framework.Euclidean.Vector2();
            }
        },
        constructor: function () {
        },
