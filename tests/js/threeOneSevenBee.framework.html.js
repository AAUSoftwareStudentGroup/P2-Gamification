(function (globals) {
    ...
    Bridge.define('ThreeOneSevenBee.Framework.Html.ElementInput', {
        ...
        onMouseEnter: function (e) {
            ...
            if (!this.pointers.tryGetValue(Bridge.get(ThreeOneSevenBee.Framework.Html.ElementInput).MOUSE_ID, pointer)) {
                pointer.v = new ThreeOneSevenBee.Framework.Html.Pointer("constructor$1", Bridge.get(ThreeOneSevenBee.Framework.Html.ElementInput).MOUSE_ID, ThreeOneSevenBee.Framework.Html.PointerTypes.mouse);
            }
            ...
            if (Bridge.hasValue(pointerEnter)) {
        ...
        onMouseDown: function (e) {
            ...
            if (Bridge.hasValue(pointerDown)) {
        ...
        onMouseMove: function (e) {
            ...
            if (Bridge.hasValue(pointerMove)) {
        ...
        onMouseLeave: function (e) {
            ...
            if (Bridge.hasValue(pointerLeave)) {
        ...
        onTouchStart: function (e) {
            ...
            while ($t.moveNext()) {
                ...
                if (!this.pointers.tryGetValue(touch.identifier, pointer)) {
                    pointer.v = new ThreeOneSevenBee.Framework.Html.Pointer("constructor$1", touch.identifier, ThreeOneSevenBee.Framework.Html.PointerTypes.touch);
                }
        ...
        onTouchMove: function (e) {
            ...
            while ($t.moveNext()) {
                ...
                var pointer = { };
                if (!this.pointers.tryGetValue(touch.identifier, pointer)) {
                    pointer.v = new ThreeOneSevenBee.Framework.Html.Pointer("constructor$1", touch.identifier, ThreeOneSevenBee.Framework.Html.PointerTypes.mouse);
                }
        ...
        onTouchEnd: function (e) {
            ...
            while ($t.moveNext()) {
                ...
                var pointer = { };
                if (!this.pointers.tryGetValue(touch.identifier, pointer)) {
                    this.pointers.set(touch.identifier, ($t1 = new ThreeOneSevenBee.Framework.Html.Pointer("constructor$1", touch.identifier, ThreeOneSevenBee.Framework.Html.PointerTypes.mouse), pointer.v = $t1, $t1));
                }
                pointer.v.update$1(touch, this.getElement());
    ...
    Bridge.define('ThreeOneSevenBee.Framework.Html.Pointer', {
        ...
        constructor: function (e, relativeTo) {
            ThreeOneSevenBee.Framework.Html.Pointer.prototype.constructor$1.call(this, 0, ThreeOneSevenBee.Framework.Html.PointerTypes.touch);
        ...
        constructor$2: function (e, relativeTo) {
            ThreeOneSevenBee.Framework.Html.Pointer.prototype.constructor$1.call(this, e.identifier, ThreeOneSevenBee.Framework.Html.PointerTypes.touch);
        ...
        update: function (e, relativeTo) {
            if (!(this.getType() === ThreeOneSevenBee.Framework.Html.PointerTypes.mouse)) {
        ...
        update$1: function (e, relativeTo) {
            if (!(this.getType() === ThreeOneSevenBee.Framework.Html.PointerTypes.touch)) {
